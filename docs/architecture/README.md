...
4. [Manifest Schema](./manifest-schema.md)：补充理解工具清单与 capability index 的字段事实来源。
5. [Trace Schema](./trace-schema.md)：补充理解 trace、artifact、audit report 如何支撑 dashboard 读路径。
6. [模块接口 / Module Interfaces](./module-interfaces.md)：查阅跨模块 public API、命令映射与调用契约。
...
- [模块边界](./module-boundaries.md)
- [运行时生命周期](./runtime-lifecycle.md)
- [模块接口](./module-interfaces.md)

这条路径聚焦 SDK 作为编排核心、CLI 作为壳层入口的边界。
